...
<qgis version="3.28.10-Firenze">
  <identifier>REFER_COUNTY</identifier>
  <parentidentifier></parentidentifier>
  <language>ENG</language>
  <type>dataset</type>
  <title>REFER_COUNTY</title>
  <abstract>Boundaries of the 88 counties in Ohio. Update frequency: Annual.


Boundaries of the 88 counties in Ohio </abstract>
  <keywords vocabulary="Search keys">
    <keyword>ODOT</keyword>
    <keyword>TIMS</keyword>
    <keyword>BOUNDARIES</keyword>
    <keyword>COUNTY</keyword>
  </keywords>
  <contact>
    <name></name>
    <organization>Ohio Department of Transportation, Office of Technical Services</organization>
    <position></position>
    <voice></voice>
    <fax></fax>
    <email></email>
  ...
  <extent>
    <spatial dimensions="2" crs="EPSG:3857" miny="38.40310000000000201" maxy="41.9772000000000034" maxz="0" minz="0" maxx="-80.51890000000000214" minx="-84.8200999999999965"/>
    <temporal>
      <period>
        <start></start>
        <end></end>
